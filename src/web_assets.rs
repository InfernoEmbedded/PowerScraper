                    ...
                    <div style="display: flex; align-items: center; gap: 15px;">
                        ...
                        <div>
                            ...
                            <p style="margin: 0; font-size: 0.95rem; line-height: 1.5;" class="text-muted">
                                ...
                                <strong style="color: var(--accent);">Force Charge: <span id="suggest-charge-val">-</span>¢</strong> (5th percentile of import capped at 1/4 of median import) and 
                                <strong style="color: #fff; background: var(--primary); padding: 2px 8px; border-radius: 4px; font-weight: 600;">Force Discharge: <span id="suggest-discharge-val">-</span>¢</strong> (95th percentile of export floored at 4x median export).
                            </p>
                        </div>
                    </div>
                </div>
