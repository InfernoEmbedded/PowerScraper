...
<body>
    ...
    <main>
                    ...
                    <div style="display: flex; align-items: center; gap: 15px;">
                        ...
                        <div>
                            ...
                            <p style="margin: 0; font-size: 0.95rem; line-height: 1.5;" class="text-muted">
                                ...
                                <strong style="color: #fff; background: var(--primary); padding: 2px 8px; border-radius: 4px; font-weight: 600;">Force Discharge: <span id="suggest-discharge-val">-</span>¢</strong> (99th percentile of export floored at 3x median import).
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div id="tab-history" class="tab-content">
            ...
            <div class="glass-card" style="margin-top: 20px;">
                <div class="card-title">Export Historical Telemetry</div>
                <p class="text-muted" style="margin-bottom: 15px;">Download all stored telemetry records as a wide CSV dataset file.</p>
                <a href="/api/telemetry/export.csv" download class="btn-apply" style="display: inline-block; text-decoration: none;">Download CSV Dataset</a>
            </div>
